...
interface UsageData {
  ...
  logs: UsageLog[]
  plan: string
  planLimits: { monthlyRequests: number; maxApiKeys: number }
  successRate: number
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-border bg-secondary/30">
                <th className="text-left px-6 py-3 text-caption font-medium text-foreground-tertiary">Time</th>
                <th className="text-left px-6 py-3 text-caption font-medium text-foreground-tertiary">Endpoint</th>
                <th className="text-left px-6 py-3 text-caption font-medium text-foreground-tertiary">Status</th>
                <th className="text-left px-6 py-3 text-caption font-medium text-foreground-tertiary">Response Time</th>
              </tr>
            </thead>
