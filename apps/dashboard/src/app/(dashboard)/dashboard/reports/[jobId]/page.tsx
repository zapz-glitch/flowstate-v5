      ...
      {displayValuation && showStickyBar && (
        <div className="sticky top-0 z-10 no-print">
          <div className={cn(
            ...
            <div className="px-3 sm:px-4 py-2 sm:py-3 flex items-center gap-3 sm:gap-4 flex-wrap">
              <div className="flex items-center gap-2 flex-shrink-0">
                <DollarSign className="w-4 h-4 text-primary" />
                <span className="text-caption font-medium text-foreground-secondary hidden sm:inline">Valuation</span>
                {isRecalculated && (
              ...
              <div className="flex items-center gap-3 sm:gap-5 flex-1 min-w-0 flex-wrap">
